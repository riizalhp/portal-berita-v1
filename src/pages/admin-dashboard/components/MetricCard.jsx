...
const MetricCard = ({ title, value, change, changeType, icon, color = 'primary' }) => {
  ...
  return (
    <div className="bg-card border border-border rounded-lg p-6 hover:shadow-elevated transition-shadow duration-200">
      ...
      <div>
        <h3 className="text-2xl font-heading font-bold text-text-primary mb-1">{value}</h3>
